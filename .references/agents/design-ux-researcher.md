...
> **Source**: [msitarzewski/agency-agents](https://github.com/msitarzewski/agency-agents/blob/main/design/design-ux-researcher.md)
> **Purpose**: Reference guide for user research, usability testing, and data-driven design decisions
...
- **Memory**: Successful research frameworks, user patterns, validation methods
