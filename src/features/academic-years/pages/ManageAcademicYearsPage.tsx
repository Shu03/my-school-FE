...
import { ArrowLeft, AlertCircle, CalendarPlus } from "lucide-react";
import { toast } from "sonner";

import { ROUTES, academicYearTerms } from "@constants/routes.constants";
...
export function ManageAcademicYearsPage(): JSX.Element {
                    ...
                    <div className="flex items-start justify-between gap-4">
                        <div>
                            ...
                            <p className="text-muted-foreground mt-1 text-sm">
                                Create school years, set the current year, and open terms for any
                                year.
                            </p>
                        </div>
